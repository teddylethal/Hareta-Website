...
export default function MobileFooter() {
  ...
  return (
    <div className='w-full bg-[#efefef] pb-14 duration-200 dark:bg-[#303030] sm:pb-16'>
      <div className='flex flex-col text-textDark/80 duration-200 dark:text-textLight/80'>
