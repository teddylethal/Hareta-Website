  ...
  return (
    <div className='w-full bg-lightWhite700 pb-12 pt-12 duration-200 dark:bg-darkGray700'>
      <div className='container'>
        <div className=' grid grid-cols-5 gap-1 text-sm font-medium uppercase text-black duration-200 dark:text-white lg:gap-2 lg:text-xl xl:gap-4 xl:text-2xl'>
        ...
        <div className='mt-4 grid grid-cols-5 justify-center gap-1 text-xs text-textDark/80 duration-200 dark:text-textLight/80 lg:gap-2 lg:text-base xl:gap-4'>
        ...
        <div className='relative grid grid-cols-5 gap-1 lg:gap-2 xl:gap-4'>
          <div className='col-span-2 flex items-center justify-center space-x-2 lg:space-x-4'>
            ...
            <div className='uppercase text-textDark/80 duration-200 dark:text-textLight/80'>
              <p className='text-lg lg:text-xl xl:text-2xl'>hareta</p>
              <p className='pl-4  text-sm lg:text-base xl:text-lg'>workshop</p>
            </div>
          </div>
          <div className='absolute bottom-0 flex w-full items-center justify-center text-xs text-textDark/60 duration-200 dark:text-textLight/60 lg:text-sm'>
            {t('coppyright')}
          </div>
        </div>
      </div>
