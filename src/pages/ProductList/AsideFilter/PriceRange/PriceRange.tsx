      ...
      {active && (
        <button
          className={classNames(
            'lg:text-sm xl:text-base absolute right-0 top-0 mt-1 rounded-md px-4 py-1 text-xs text-red-500 duration-200 hover:underline dark:hover:outline-red-500'
          )}
          onClick={handleReset}
          type='button'
        >
      ...
      <form className='mx-2 my-1' onSubmit={onSubmit}>
        <div className='flex items-center justify-center'>
          <div className='flex items-center'>
            <input
              className='text-darkText sm:text-sm lg:w-14 lg:text-sm xl:w-20 dark:text-lightText w-full rounded-md bg-white p-1 text-center text-xs capitalize outline outline-1 outline-black/40 duration-200 focus:shadow-sm dark:bg-black dark:outline-white/40'
          ...
          <div className='text-darkText dark:text-lightText m-2 duration-200'>-</div>
        ...
        <div className='mt-2 flex items-center justify-center space-x-4'>
          <button
            ...
            className={classNames(
              'text-darkText sm:text-sm lg:text-sm xl:text-base dark:text-lightText mt-1 flex items-center justify-center rounded-md bg-white px-8 py-1 text-xs font-medium capitalize outline outline-1 duration-200 dark:bg-[#101010]',
              {
