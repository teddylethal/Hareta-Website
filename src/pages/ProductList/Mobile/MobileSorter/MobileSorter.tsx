...
export default function MobileSorter() {
  ...
  return (
    <Fragment>
      <button
        onClick={open}
        className='flex w-[60%] items-center justify-center rounded-md bg-vintageColor/80 px-4 py-1 text-sm text-textDark dark:bg-haretaColor/80 dark:text-textLight sm:text-base'
      >
        {sorting}
      </button>
      <AnimatePresence>
