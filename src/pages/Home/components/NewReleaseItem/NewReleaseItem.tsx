...
export default function NewReleaseItem({ product }: Props) {
  ...
  return (
    <button className='w-full items-start text-left' onClick={handleClickItem}>
      <div className='grid w-full grid-cols-3 gap-2 px-8 py-8 xl:gap-4 xl:px-12 xl:py-10'>
        ...
        <div className='col-span-2 '>
          <div className='flex h-full flex-col justify-between pl-8 xl:pl-12'>
            <div className=''>
