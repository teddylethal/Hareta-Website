      ...
      <Carousel
        ...
        customLeftArrow={
          <ArrowFix>
            <FontAwesomeIcon
              icon={faChevronLeft}
              className='text-primary-400 xl:h-10 xl:hover:h-12 absolute left-4 top-1/2 h-6 w-auto -translate-y-1/2 cursor-pointer rounded-full p-4 text-textDark/60 duration-200 hover:h-7 hover:text-textDark dark:text-textLight/60 dark:hover:text-textLight'
            />
          </ArrowFix>
        }
        customRightArrow={
          <ArrowFix>
            <FontAwesomeIcon
              icon={faChevronRight}
              className='text-primary-400 xl:h-10 xl:hover:h-12 absolute right-4 top-1/2 h-6 w-auto -translate-y-1/2 cursor-pointer rounded-full p-4 text-textDark/60 duration-200 hover:h-7 hover:text-textDark dark:text-textLight/60 dark:hover:text-textLight'
            />
          </ArrowFix>
        }
      >
