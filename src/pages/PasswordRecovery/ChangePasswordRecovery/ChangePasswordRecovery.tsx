              ...
              <div className='md:col-start-2 md:col-end-6 lg:col-span-3 lg:col-end-7'>
                ...
                >
                  ...
                  <div className='mt-4 flex flex-col items-center'>
                    <div className='flex items-center'>
                      <svg
                        ...
                        viewBox='0 0 24 24'
                        fill='currentColor'
                        className='md:h-8 md:w-8 h-6 w-6 fill-black duration-200 dark:fill-vintageColor'
                      >
                        <>
                    ...
                    <div className='sm:text-xl ml-3 w-full truncate text-center text-sm text-blue-700 dark:text-blue-400'>
                  ...
                  <AccountInput
                    ...
                    register={register}
                    type='password'
                    className='autofill:text-darkText autofill:dark:text-lightText mt-8 autofill:bg-red-400'
