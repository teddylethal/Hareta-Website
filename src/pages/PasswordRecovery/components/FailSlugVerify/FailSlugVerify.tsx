...
export default function FailSlugVerify({ dialog, closeDialog }: Props) {
  return (
    <VerifyEmailPopup
      isOpen={dialog}
    ...
    >
      <p className='text-3xl font-semibold '>Password Recovery</p>
      <div className='flex items-center py-2 pl-2'>
        ...
        <div className='h-full pl-5 text-left text-gray-400 '>
          <p className='text-xl'>Invalid Recovery</p>
          <p className='mb-3 text-xl'>Please send another request</p>
          <button
